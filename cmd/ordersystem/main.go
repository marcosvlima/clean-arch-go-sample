...
func main() {
	...
	// Register GET for listing orders and POST for creating
	webserver.AddHandlerMethod("/order", "GET", webOrderHandler.List)
	webserver.AddHandlerMethod("/order", "POST", webOrderHandler.Create)
